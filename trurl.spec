...
Version  : 0.16.1
Release  : 11
URL      : https://github.com/curl/trurl/archive/trurl-0.16.1/trurl-0.16.1.tar.gz
Source0  : https://github.com/curl/trurl/archive/trurl-0.16.1/trurl-0.16.1.tar.gz
...
%prep
%setup -q -n trurl-trurl-0.16.1
cd %{_builddir}/trurl-trurl-0.16.1
pushd ..
cp -a trurl-trurl-0.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747060043
