...
Version  : 0.13
Release  : 7
URL      : https://github.com/curl/trurl/archive/trurl-0.13/trurl-0.13.tar.gz
Source0  : https://github.com/curl/trurl/archive/trurl-0.13/trurl-0.13.tar.gz
...
%prep
%setup -q -n trurl-trurl-0.13
cd %{_builddir}/trurl-trurl-0.13
pushd ..
cp -a trurl-trurl-0.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715789665
