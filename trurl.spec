...
Version  : 0.10
Release  : 4
URL      : https://github.com/curl/trurl/archive/trurl-0.10/trurl-0.10.tar.gz
Source0  : https://github.com/curl/trurl/archive/trurl-0.10/trurl-0.10.tar.gz
...
%prep
%setup -q -n trurl-trurl-0.10
cd %{_builddir}/trurl-trurl-0.10
pushd ..
cp -a trurl-trurl-0.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708446374
